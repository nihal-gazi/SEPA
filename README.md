## SEPA: Sentence Embedding Predictive Architecture (formerly GSCv3)
...
```text
.
├── dataset.txt                     # Raw text corpus (e.g., TinyStories)
├── dataset_10.txt                  # 10MB subset
├── dataset_5.txt                   # 5MB subset
├── README.md                       # This file
├── tinystories_1m.txt              
│   
├── GSCv3/                          # Core SEPA Library
